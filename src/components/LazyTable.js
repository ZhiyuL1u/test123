...
export default function LazyTable({ route, columns, defaultPageSize, rowsPerPageOptions }) {
  ...
  const handleChangePageSize = (e) => {
    ...
    const newPageSize = parseInt(e.target.value); // Ensure the new page size is an integer

    // Set the pageSize state variable to the new value and reset the current page to 1
